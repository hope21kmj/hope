...
/** Fork Timers **/
static const unsigned int FORK_TIME = 1549451400; //  2019-02-05   (DriftFix and PoS reward to 5 HOC)
...
inline bool IsProtocolV3(int64_t nTime) { return TestNet() || nTime > 1548587400; }
