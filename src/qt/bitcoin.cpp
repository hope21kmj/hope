...
int main(int argc, char *argv[])
{
    ...
    {
        QMessageBox::critical(0, QObject::tr("Hopecoin"),
    ...
    app.setOrganizationName("Hopecoin");
    //XXX app.setOrganizationDomain("");
    if(GetBoolArg("-testnet", false)) // Separate UI settings for testnet
        app.setApplicationName("Hopecoin-Qt-testnet");
    else
        app.setApplicationName("Hopecoin-Qt");
