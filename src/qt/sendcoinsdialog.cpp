    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Hopecoin address (e.g. WPT7ufM1tz2uzV7x9sG26z4CuhWs2B18Rw)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid Hopecoin address"));
        }
        else
        {
...
bool SendCoinsDialog::quickSend()
{
    ...
    case WalletModel::OK:
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm send coins"),
											                          tr("%1 hopecoins had been sent,the remaining %2 hopecoins continue ?").arg((double)sendstatus.fee/COIN).arg((double)reAmount/COIN),
