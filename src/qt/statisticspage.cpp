...
uint64_t destroyedStakec =  65217844.265830 * COIN;  //https://www.richlist.eu/hopecoin/stats/destroyed
...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " HOC" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " HOC" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " HOC");
    }
    
    ui->rewardBox->setText(QString::number(nMint, 'f', 6) + " HOC");
    //ui->circBox->setText(QLocale(QLocale::English).toString(aliveVolume) + " HOC"); 
